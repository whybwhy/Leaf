...
public enum GlobalExceptionMessage {
    ...
    INVALID_TOKEN_ALL_DONE(10003, "토큰이 모두 사용되었습니다"),
    INVALID_USER(10004, "올바르지 않은 사용자 입니다."),
    INVALID_TOKEN_BY_ROOM(10005, "해당 채팅방에서 발급된 토큰이 아닙니다."),
    INVALID_ROOM(10006, "올바르지 않은 채팅방 입니다."),
    INVALID_USER_AND_ROOM(10007, "올바르지 않은 채팅방 혹은 사용자입니다."),
    ...
    INVALID_TOKEN_OWNER(10013, "토큰를 생성한 사용자가 아닙니다."),
    INVALID_EXPIRED_TOKE(10014, "발급 7일 이내의 건 만 조회가 가능합니다.")
    ;
